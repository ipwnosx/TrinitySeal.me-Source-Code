...
Namespace Seal
    Class SealCheck
        ...
        Public Shared Sub HashChecks()
            If CalculateMD5("Newtonsoft.Json.dll") <> "4df6c8781e70c3a4912b5be796e6d337" OrElse CalculateMD5(GetType(TrinitySeal.Seal).Assembly.Location) <> "0788cb32d5eb03916c701e0d18e25a74" Then
