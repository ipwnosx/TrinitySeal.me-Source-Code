...
<html>
	...
	<meta name="description" content="The most secure & easy to use .NET licensing solution" />
	<meta name="keywords" content="trinityseal, trinity seal, jake lazaros, centos.x, .net, programming, licensing, authentication, user, users, user integration, security, c#, vb, vb.net" />
...
<script>
     (adsbygoogle = window.adsbygoogle || []).push({
          google_ad_client: "ca-pub-9682141061003029",
	...
	<div id="gtco-header" data-section="home" class="gtco-cover header-fixed" role="banner" style="background-image:url(images/bck.png);">
				...
				<div class="col-md-12 col-md-offset-0 text-center">
					<div class="display-t">
						<div class="display-tc">
							...
							<p class="animate-box" data-animate-effect="fadeIn"><a href="https://trinityseal.gitbook.io/trinityseal/" class="btn btn-primary btn-lg">View documentation</a></p>
							<p class="animate-box" data-animate-effect="fadeIn"><a href="https://trinityseal.me/purchase.php" class="btn btn-primary btn-lg">Purchase Premium</a></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row text-center">
				<div class="display-t">
					<div class="display-tc">
						<div class="col-md-12">
							<iframe src="https://discordapp.com/widget?id=642450255740141608&theme=dark" width="300" height="450" allowtransparency="true" frameborder="0"></iframe><br>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-pb-md">
				...
				<div class="col-md-4">
					<div class="gtco-widget">
						<h3>About Us</h3>
						<p>TrinitySeal is one of my most prized projects thus far. We are the only reliable .NET licensing solution that offers great service and security for no cost.</p>
					</div>
				</div>
