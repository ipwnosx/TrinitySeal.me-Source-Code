...
<html>
    <head>
		<title>TrinitySeal - Programs</title>
        ...
        <div class="ui inverted segment">
            <div class="ui inverted secondary menu">
                  <div class="header item"><i class="material-icons">ac_unit</i><b>Trinity<b style="color: #FF0000">Seal</b> BETA</b></div> 
                    ...
                    <a class="red active item" href="#">Hub</a>
...
?>
                    <center><b><font color="red">Application secret: <font color="white"><?php echo $key1; ?></font></font></b></center><br>
        <div class="ui container">
            <div style="margin:auto; width:1000px; margin-bottom: 15px" class="ui inverted segment">
                <h2 class="ui inverted dividing header">Hub</h2>
                 <div class="col-md-3"><font color="white">DLL Version: <b>3.3</b> **<b>Important Security Update** **USE THE NEW SEALCHECK CLASS!</b>**</font></div><br>
                    <a href="/download"><button class="ui fluid red button">Download Files</button></a>
                    <br>
                    <a href="https://trinityseal.gitbook.io/trinityseal/"><button class="ui fluid red button">View Documentation</button></a>
                    <br>
                    <a href="https://www.youtube.com/watch?v=sdgepRy0BYw&feature=youtu.be"><button class="ui fluid red button">Watch Tutorial</button></a>
                    <br>
                    <a href="https://trinityseal.me/dashboard/programs/download/HashChecker.zip"><button class="ui fluid red button">Download Hash Checker</button></a>
                    <br>
                    <a href="https://trinityseal.me/purchase.php"><button class="ui fluid red button">Purchase Premium</button></a>
            </div>
            
            <div class="ui container">
            <div style="margin:auto; width:1000px; margin-bottom: 15px" class="ui inverted segment">
<h2 class="ui inverted dividing header">Showcase</h2>
<center><iframe width="950" height="500"
src="https://www.youtube.com/embed/iviUS7_Zll0">
</iframe></center>
</div>
