...
<html>
    <head>
		<title>TrinitySeal - Leaderboards</title>
            ...
            <div class="ui inverted secondary menu">
                  <div class="header item"><i class="material-icons">ac_unit</i><b>Trinity<b style="color: #FF0000">Seal</b> BETA</b></div>    
                    ...
                    <a href="redeemtoken.php" class="red item">Redeem Token</a>
                     ...
                     <a class="red active item">Leaderboards</a>
...
if(mysqli_num_rows($bancheck) >= 1){
    echo "<div style=\"margin:auto;margin-top:10px;width:700px;\" class=\"ui negative message\">
        ...
        <div style="margin:auto; width:1000px; margin-bottom: 15px" class="ui inverted segment">
                <h2 class="ui inverted dividing header">Most Users</h2>
          ...
          <tbody>
            <tr>
              ...
              $grabusers = mysqli_query($con, "SELECT * FROM `programs` ORDER BY `clients` DESC LIMIT 5") or die(mysqli_error($con));
         
              while($row = mysqli_fetch_array($grabusers)){
              {
                
                echo '
                <tr>
                <td class="gtext">'.xss_clean($row['owner']).'</td>
                <td class="gtext">'.xss_clean($row['name']).'</td>
                <td class="gtext">'.xss_clean($row['clients']).'</td>
                <td>
                '
                ;
